...
const PRIORITY_MAP = {
  ...
  '/prensa/': { changefreq: 'monthly', priority: '0.6' },
  ...
  '/blog/wordpress-automatizacion-ia-pymes/': { changefreq: 'monthly', priority: '0.6' },
  '/blog/automatizacion-web-ia-leads-pymes/': { changefreq: 'monthly', priority: '0.6' },
  '/blog/macros-scripts-automatizacion-ia-pymes/': { changefreq: 'monthly', priority: '0.6' },
  ...
  '/blog/automatizacion-tiktok-ia-pymes-servicios/': { changefreq: 'monthly', priority: '0.6' },
  '/blog/excel-ia-automatizacion-tareas-pymes/': { changefreq: 'monthly', priority: '0.6' },
  '/blog/automatizacion-negocios-ia-pymes-servicios/': { changefreq: 'monthly', priority: '0.6' },
  '/blog/comparativa-automatizacion-ia-atencion-cliente-pymes/': { changefreq: 'monthly', priority: '0.6' },
  '/blog/ia-local-automatizacion-procesos-pymes/': { changefreq: 'monthly', priority: '0.6' },
  '/blog/automatizacion-tareas-ia-vs-procesos-pymes/': { changefreq: 'monthly', priority: '0.6' },
