...
const Cases: React.FC = () => {
  return (
    <section id="casos" className="pt-14 pb-24 sm:py-32 px-6">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-5xl lg:text-7xl font-black tracking-tighter uppercase mb-14 sm:mb-24">Casos de <br/><span className="text-cyber-purple italic">Impacto Real</span></h2>
