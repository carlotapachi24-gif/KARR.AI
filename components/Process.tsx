  ...
  return (
    <section id="como-funciona" className="py-32 bg-white/5 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <h2 className="reveal text-[2.75rem] sm:text-5xl lg:text-7xl font-black tracking-tighter uppercase mb-24 text-center leading-[0.95]">
          <span className="block sm:inline whitespace-nowrap">Protocolo de</span>{' '}
          <span className="block sm:inline whitespace-nowrap">Implementación</span>
        </h2>
