...
const Results: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const loop = () => {
      setStage(0);
      setTimeout(() => setStage(1), 500);   // Message appears
      setTimeout(() => setStage(2), 2500);  // Line to System
      setTimeout(() => setStage(3), 3000);  // System Processing
      setTimeout(() => setStage(4), 5000);  // System Ready
      setTimeout(() => setStage(5), 6000);  // Line to Results
      setTimeout(() => setStage(6), 6500);  // Result 1
      setTimeout(() => setStage(7), 7000);  // Result 2
      setTimeout(() => setStage(8), 7500);  // Result 3
      setTimeout(() => setStage(9), 9000);  // Seal
    };
